...
import { STATE_SENDED, ROL_USER, STATE_DISPATCH, STATE_CANCELED, MAX_TEMPLATE_SIZE, ROL_ADMIN } from "./Properties";
...
const DirectoryTable = (props) => {
  ...
  return (
    <div className="container">
      <div className="table-container table-responsive"  style={{ maxHeight: "80vh", overflowY: "scroll" }}>
              ...
              updateAlbums.map((album) => {
                ...
                return (
                  <tr key={album._id}>
                    ...
                    <td>{album.estado}</td>
                    <td>{album.courier}</td>
                    <td>{!isCanceled || !isAdmin ? album.motivoCancelacion :
                      <textarea
